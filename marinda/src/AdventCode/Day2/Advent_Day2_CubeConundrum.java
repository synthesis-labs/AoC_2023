...
public class Advent_Day2_CubeConundrum {

    private int loadedRed;
    private int loadedGreen;
    private int loadedBlue;

    public Advent_Day2_CubeConundrum(int loadedRed, int loadedGreen, int loadedBlue) {
        this.loadedRed = loadedRed;
        this.loadedGreen = loadedGreen;
        this.loadedBlue = loadedBlue;
    }
        ...
        for (String game : gameRecords) {
            ...
            if (matcher_GameID_Sets.find()) {
                ...
                for (String set : setsArray) {
                    ...
                    gamePossible = gamePossible && redCubes <= loadedRed && greenCubes <= loadedGreen && blueCubes <= loadedBlue;
                }
            }
