...
public class Advent_Day2_CubeConundrum_Tests {
    ...
    public void Part1_Test_SampleData() {
        ...
        Advent_Day2_CubeConundrum advent_Day2_CubeConundrum = new Advent_Day2_CubeConundrum(12, 13, 14);

        ArrayList<String> sampleData = new ArrayList<>();
        sampleData.add("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green");
        sampleData.add("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue");
        sampleData.add("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red");
        sampleData.add("Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red");
        sampleData.add("Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green");

        int possibleGameIDsSum = advent_Day2_CubeConundrum.Part1(sampleData);
    ...
    public void Part1_Test_RealData() throws IOException {
        ...
        ArrayList<String> data = (ArrayList<String>) Files.readAllLines(Paths.get("./src/Data/Advent_Day2_CubeConundrum_Data.txt"));

        int possibleGameIDsSum = advent_Day2_CubeConundrum.Part1(data);
    ...
    public void Part2_Test_SampleData() {
        Advent_Day2_CubeConundrum advent_Day2_CubeConundrum = new Advent_Day2_CubeConundrum(0, 0, 0);
        ...
        int powerOfSetsSum = advent_Day2_CubeConundrum.Part2(sampleData);
    ...
    public void Part2_Test_RealData() throws IOException {
        ...
        int powerOfSetsSum = advent_Day2_CubeConundrum.Part2(data);
